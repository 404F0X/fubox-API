...
当前活跃方向：
- **E8-004-S8（Mencius，已完成）**：TPM estimate 到 reservation capacity 的 runtime bridge contract。
...
- **E13-005-S8 Gateway（Pauli，已完成）**：Prompt Protection no-side-effect regression 扩展到 native provider path。
