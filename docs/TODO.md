...
- **E11-007-S13 Backend（Goodall，已完成）**：ledger execute OpenAPI contract validation gate。
- **E13-005-S10（Pauli，已完成）**：Prompt Protection provider_attempts Postgres proof runbook。
