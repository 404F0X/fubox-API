...
当前活跃方向：
- **E8-004-S7（Mencius）**：TPM reservation estimate overflow/minimum edge-case hardening。
...
- **E11-007-S7 UI（Godel）**：Billing/Price 页面接通真实 ledger adjustment execute 提交。
