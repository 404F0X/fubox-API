...
当前活跃方向：
- **E8-004-S9（Mencius，已完成）**：Gateway TPM runtime wiring 设计/验收文档。
...
- **E13-005-S9 Gateway（Pauli，已完成）**：Prompt Protection no-side-effect regression 扩展到 Gemini native path。
