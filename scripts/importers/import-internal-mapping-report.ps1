...
$report = [ordered]@{
  ...
  next_steps = @(
    ...
    "Bind source channel ids to internal channels and enter provider keys through the secret-management path; this report intentionally omits secret material.",
